...
// Sample training data for employee (read-only)
const trainings = ref([
    {
        id: 1,
...
<template>
    <div class="p-6">
        <!-- Header -->
        <div
            class="w-full bg-white rounded-2xl p-6 shadow-sm border border-blue-100 flex flex-col md:flex-row justify-between items-start md:items-center gap-4"
        >
            <div>
                <h1 class="text-3xl font-bold text-brand-blue">My Training</h1>
                <p class="text-gray-500 mt-1">
                    Track your assigned and completed trainings here.
                </p>
            </div>
        </div>
