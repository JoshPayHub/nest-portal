...
const filteredCases = computed(() => {
    ...
    return caseRecords.value.filter((c) =>
        c.caseType.toLowerCase().includes(searchCase.value.toLowerCase()),
    );
});

// Case summary for employee view
const caseSummary = ref([
    { label: "Ongoing", count: 1, color: "text-yellow-500" },
    { label: "Pending", count: 1, color: "text-red-500" },
    { label: "Resolved", count: 0, color: "text-green-500" },
]);
</script>
...
<template>
    <div class="p-6">
        ...
        >
            <div>
                ...
                <p class="text-gray-500 mt-1">
                    View your disciplinary cases and their current status.
                </p>
            </div>
        </div>
        ...
        >
            <h2 class="text-xl font-semibold text-brand-blue mb-4">My Cases</h2>
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="py-2 px-3 text-center">
                            <Link
                                :href="`/employee/cases/${record.id}/view`"
