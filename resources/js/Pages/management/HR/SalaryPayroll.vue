...
const openView = (item) => {
    router.get(`/hr/salary-payroll/${item.id}/list`);
};
</script>
                ...
                >
                    <div>
                        <CardTitle
                            ...
                            >Salary Payroll</CardTitle
                        >
                        <CardDescription class="text-base mt-1 text-slate-500"
                            >Manage payroll period ranges</CardDescription
                        >
                    </div>
                </div>
            </CardHeader>
                        ...
                        <TableHeader class="bg-slate-50/50">
                            <TableRow>
                                ...
                                <TableHead
                                    ...
                                    >Total Pending</TableHead
                                >
                                <TableHead
                                    class="text-center font-bold text-slate-600 uppercase text-xs"
                                    >Total Approved</TableHead
                                >
                                <TableHead
